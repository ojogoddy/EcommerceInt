  ...
  return (
    <div className='bg-white text-[black] items-center flex justify-center flex-col mx-[9rem] py-[3rem] md:mx-[3rem] sm:mx-[2rem] '>
        <div className='flex items-center justify-center bg-[#f4f4f4]  sm:flex-col-reverse '>
            <div className='h-[600px] w-[50%] sm:w-full sm:h-full bg-[#f4f4f4] p-5 flex gap-[30px] flex-col justify-center text-[50px]'>
                <div className=''>
                    <div className='text-[55px] sm:text-[45px] text-left leading-10 font-semibold sm:text-center'>
                        Mixed Pieces 
                        Earings
                    </div>
              
                </div>
                        <p className='text-[1rem] text-[#b6acac]'>
        ...
        <div className=' flex flex-col justify-center items-center mt-5 '>
            ...
            <div className='flex gap-5 md:gap-5 md:flex-wrap sm:flex-wrap items-center justify-center cursor-pointer mb-5'>
                <div className='sm:space-y-3 w-full'>
                    <div className='h-[300px] mb-3 sm:w-[320px]'>
                ...
                <div className='sm:space-y-3 w-full'>
                    <div className='h-[300px] mb-3 w-full sm:w-[320px]'>
                        <img className='w-[100%]  h-[100%]'
                            src={D3} alt="" />
                    </div>
                    <div className='text-center'>
